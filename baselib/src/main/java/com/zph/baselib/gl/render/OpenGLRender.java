...
//		gl.glColor4f(1.0f, 0.0f, 0.0f, 1.0f);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        mTriangleBuffer = BaseGLESSeting.floatToBuffer(mTriangleArray);
        mColorBuffer = BaseGLESSeting.floatToBuffer(mColorArray);
        quateBuffer = BaseGLESSeting.floatToBuffer(mQuateArray);
